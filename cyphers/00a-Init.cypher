...
CREATE INDEX variant_a FOR (n:Variant) ON (n.alt);
CREATE INDEX variant_y FOR (n:Variant) ON (n.variantType);
CREATE INDEX variant_c FOR (n:Variant) ON (n.variantConsequence);
CREATE INDEX variant_p FOR (n:Variant) ON (n.proteinPosition); 
